(function(){
  ...
  ready(function(){
    if (!document.getElementById('phase-c-css')) {
      ...
      s.id = 'phase-c-css';
      s.textContent = [
        '.product-search-wrap{margin:12px 0 16px;position:relative}',
        ...
        '.product-search-icon{position:absolute;left:14px;top:50%;transform:translateY(-50%);opacity:.55;pointer-events:none;font-size:16px}',
        /* Hide the extra category chips under explore — keep original top nav only */
